    ...
    public class MainViewModel : BindableObject
    {
        ...
        public string ValueFrom
        {
            get
            {
                ...
                {
                    value1 = Root.Valute[SelectedItem1].Value;
                    nominal1 = Root.Valute[SelectedItem1].Nominal;
                }
                if (SelectedItem2 == "RUB")
                {
                    value2 = 1;
                    nominal2 = 1;
                }
                ...
                {
                    value2 = Root.Valute[SelectedItem2].Value;
                    nominal2 = Root.Valute[SelectedItem2].Nominal;
                }
